...
async def _(event):
    ...
    if not pmpermit_sql.is_approved(chat_id):
        ...
        if event.is_private:
         ...
         PM = ("`Hello. You are accessing the availabe menu of @lonewol7f ,`"
               f"{DEFAULTUSER}.\n"
         ...
         ONE = ("__Okay. Your request has been registered. Do not spam my inbox.You can expect a reply within 24 light years. I am a busy man, unlike you probably.__\n\n"
         ...
         FOUR = ("__Okay. @lonewol7f has not seen your message yet.He usually responds to people,though idk about retarted ones.__\n __He'll respond when he comes back, if he wants to.There's already a lot of pending messages😶__\n **Please do not spam unless you wish to be blocked and reported.**")
         FIVE = ("`Okay. please have the basic manners as to not bother me too much. If I wish to help you, I will respond to you soon.`\n**Do not ask repeatdly else you will be blocked and reported.**")
         LWARN = ("**This is your last warning. DO NOT send another message else you will be blocked and reported. Keep patience. I will respond you ASAP.**\n__Use__ `/start` __to go back to the main menu.__")
